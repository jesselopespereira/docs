...
<ParamField body="width" type="number" default="400">
	Image width in pixels. The image will always be square (width x width).
</ParamField>
...
- The hash considers: ordered points, colors, width, polygon, and variogram parameters.

<Tip>
	For better performance, keep `width` at reasonable values ​​(400-1000px). Very
	high values ​​can significantly increase processing time.
</Tip>
